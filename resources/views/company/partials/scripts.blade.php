<script src="{{asset('dist/libs/apexcharts/dist/apexcharts.min.js?1779974228')}}" defer></script>
<script src="{{asset('dist/libs/jsvectormap/dist/jsvectormap.min.js?1779974228')}}" defer></script>
<script src="{{asset('dist/libs/jsvectormap/dist/maps/world.js?1779974228')}}" defer></script>
<script src="{{asset('dist/libs/jsvectormap/dist/maps/world-merc.js?1779974228')}}" defer></script>
<!-- END PAGE LIBRARIES -->
<!-- BEGIN GLOBAL MANDATORY SCRIPTS -->
<script src="{{asset('dist/js/tabler.min.js?1779974228')}}" defer></script>
<!-- END GLOBAL MANDATORY SCRIPTS -->
<!-- BEGIN DEMO SCRIPTS -->
<script src="{{asset('preview/js/demo.min.js?1779974228')}}" defer></script>
<!-- END DEMO SCRIPTS -->
<!-- BEGIN PAGE SCRIPTS -->
<style>
    :root {
